        ...
        <div className="w-full max-w-2xl mx-auto px-2 sm:px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex md:hidden items-center gap-3">
              ...
              <button onClick={() => setShowSettings(true)} className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors" title={t('settings', language)}>
                <Settings size={16} />
              </button>
            </div>
